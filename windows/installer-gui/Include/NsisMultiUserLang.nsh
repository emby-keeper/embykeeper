...
!ifdef LANG_SIMPCHINESE
	LangString MULTIUSER_PAGE_TITLE ${LANG_SIMPCHINESE} "安装方式选择"
	LangString MULTIUSER_INSTALL_PAGE_SUBTITLE ${LANG_SIMPCHINESE} "选择如何安装 $(^NameDA)."
	LangString MULTIUSER_UNINSTALL_PAGE_SUBTITLE ${LANG_SIMPCHINESE} "选择如何卸载 $(^NameDA)."
	LangString MULTIUSER_INSTALL_HEADER ${LANG_SIMPCHINESE} "选择将为所有用户或当前用户安装 $(^NameDA):"
	LangString MULTIUSER_UNINSTALL_HEADER ${LANG_SIMPCHINESE} "$(^NameDA) 同时有所有用户级和当前用户级安装安装.$\r$\n选择您要卸载哪个安装."
	LangString MULTIUSER_ALL_USERS ${LANG_SIMPCHINESE} "为所有用户安装"
	LangString MULTIUSER_CURRENT_USER ${LANG_SIMPCHINESE} "为当前用户安装 ({USER})"
	LangString MULTIUSER_ALL_USERS_UMUI ${LANG_SIMPCHINESE} "为当前计算机所有用户安装."
	LangString MULTIUSER_CURRENT_USER_UMUI ${LANG_SIMPCHINESE} "为当前用户安装 ({USER})"
	LangString MULTIUSER_NEW_INSTALLATION_ALL_USERS ${LANG_SIMPCHINESE} "即将进行: 为所有用户进行全新安装."
	LangString MULTIUSER_NEW_INSTALLATION_CURRENT_USER ${LANG_SIMPCHINESE} "即将进行: 为当前用户进行全新安装."
	LangString MULTIUSER_INSTALLED_ALL_USERS ${LANG_SIMPCHINESE} "已为所有用户安装版本 {VERSION} 到 $\"{FOLDER}$\"."
	LangString MULTIUSER_INSTALLED_CURRENT_USER ${LANG_SIMPCHINESE} "已为当前用户安装版本 {VERSION} 到 $\"{FOLDER}$\"."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_ALL_USERS ${LANG_SIMPCHINESE} "即将进行: 为所有用户重新安装版本 {VERSION}."
	LangString MULTIUSER_REINSTALL_SAME_VERSION_CURRENT_USER ${LANG_SIMPCHINESE} "即将进行: 为当前用户重新安装版本 {VERSION}."
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_ALL_USERS ${LANG_SIMPCHINESE} "即将进行: 为所有用户卸载版本 {OLD_VERSION} 并安装版本 {VERSION}."
	LangString MULTIUSER_REINSTALL_DIFF_VERSION_CURRENT_USER ${LANG_SIMPCHINESE} "即将进行: 为当前用户卸载版本 {OLD_VERSION} 并安装版本 {VERSION}."
	LangString MULTIUSER_RUN_AS_ADMIN ${LANG_SIMPCHINESE} "你需要以管理员身份运行安装程序"
	LangString MULTIUSER_ADMIN_CREDENTIALS_REQUIRED ${LANG_SIMPCHINESE} "需要管理员身份认证."
	LangString MULTIUSER_ADMIN_UNINSTALL_CREDENTIALS_REQUIRED ${LANG_SIMPCHINESE} "需要管理员身份认证以卸载."
	; error messages - not so important
