...
请参考 [README](https://github.com/emby-keeper/embykeeper/blob/main/README.md#%E5%8A%9F%E8%83%BD).
...
- 当本地文件不存在时, 从[预置资源库](https://github.com/emby-keeper/embykeeper-data/tree/main/data)下载:
