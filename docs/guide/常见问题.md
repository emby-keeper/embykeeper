...
如果您发现一个程序上的错误或问题, 您也可以通过 [Github Issues](https://github.com/embykeeper/embykeeper/issues) 进行反馈.
...
但是, 您需要注意不要在截图/反馈信息中带有个人隐私 (包括手机号 / Telegram UID / 用户名) 等, 若您需要发送这些信息给开发者, 高级用户请直接发送到 [PMBot](https://t.me/embykeeper_pm_bot), 其他用户请使用马赛克遮挡并发送到 [Github Issues](https://github.com/embykeeper/embykeeper/issues), 谢谢.
