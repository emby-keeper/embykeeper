...
本项目欢迎友善讨论与建议, 您可以通过 [Github Issue](https://github.com/embykeeper/embykeeper) 途径反馈, 并认可开发团队可以关闭与项目开发不直接相关的不友善讨论. 您也可以通过 [Discord 讨论群](https://discord.gg/MzkEy6cj) (推荐) 或 [Telegram 讨论群](https://t.me/embykeeperchat) 获得社区帮助.
